...
CI on pull requests to `main` runs the same Lint / Test / Vuln checks (host Go; no Docker image). Release automation uses [release-please](https://github.com/googleapis/release-please) (Go release type) to propose version bumps and changelogs from conventional commits.
